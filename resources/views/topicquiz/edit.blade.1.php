        ...
        @foreach($questions as $question)
            ...
            <tr>
                <div class="form-group">
                    ...
                    {{Form::textarea('sub_quiz_question', $question->sub_quiz_question, ['class' => 'form-control ckeditor', 'id' => 'article-ckeditor', 'placeholder' => 'Sub-topic Title'])}}
                </div>
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <div class="form-group">
                            ...
                            {{Form::textarea('sub_quiz_a', $question->sub_quiz_a, ['class' => 'form-control ckeditor', 'placeholder' => 'Enter Notes Here'])}}
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-group">
                        {{Form::label('sub_quiz_b', 'Option 2')}}
                        {{Form::textarea('sub_quiz_b', $question->sub_quiz_b, ['class' => 'form-control ckeditor', 'placeholder' => 'Enter Notes Here'])}}
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        ...
                        {{Form::textarea('sub_quiz_c', $question->sub_quiz_c, ['class' => 'form-control ckeditor', 'placeholder' => 'Enter Notes Here'])}}
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-group">
                        {{Form::label('sub_quiz_d', 'Option 4')}}
                        {{Form::textarea('sub_quiz_d', $question->sub_quiz_d, ['class' => 'form-control ckeditor', 'placeholder' => 'Enter Notes Here'])}}
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    {{Form::text('sub_quiz_answer', $question->sub_quiz_answer, ['class' => 'form-control ckeditor bg-success', 'placeholder' => 'Enter Notes Here'])}}
                </div>
            </tr>
            <?php $num++; ?>
        @endforeach
